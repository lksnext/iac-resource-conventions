...
| Resource Definition | [resource-definition.md](../../specification/resource-definition.md) | `ResourceDefinition`, `ResourceIdentityConstraints`, `ResourceRenderingConstraints` | [definitions/resource-definition.ts](../../packages/core/src/model/definitions/resource-definition.ts) | Yes | Partially implemented | Named responsibility categories only; the Specification's own ["Out of scope"](../../specification/resource-definition.md#out-of-scope-for-this-document) section still defers a concrete JSON Schema. [Specification v1.2](../../specification/README.md#specification-v12-executable-resource-constraints) normatively defined `min_length`, structured `character_constraints`, `starts_with`/`ends_with`, `forbidden_prefixes`/`forbidden_suffixes`, and structured Placement Constraints (`statement`/optional `rule`) — Specification defined, TypeScript implementation pending; the existing `ResourceRenderingConstraints`/`placement_constraints` fields above have not been updated to match |
...
| Convention Validation | [convention-result.md#conceptual-contents](../../specification/convention-result.md#conceptual-contents) | `ConventionValidation`, `ConventionValidationFailure`, `ConventionWarning` | [results/convention-result.ts](../../packages/core/src/model/results/convention-result.ts) | Yes | Implemented | A `valid` flag plus optional failures/warnings. [Specification v1.2](../../specification/README.md#specification-v12-executable-resource-constraints) additively defined a closed, optional `code` vocabulary for `ConventionValidationFailure` (see [`resource-definition.md#validation-behavior-and-failure-semantics-specification-v12`](../../specification/resource-definition.md#validation-behavior-and-failure-semantics-specification-v12)) — Specification defined, TypeScript implementation pending; the existing contract has not been updated to add it |
